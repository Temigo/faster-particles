...
class PPN(object):
    ...
    def test_image(self, sess, blob):
        ...
        im_proposals, im_labels, im_scores, ppn2_proposals, ppn2_positives, rois, ppn2_pixels_pred, summary = sess.run([
            ...
            self._predictions['ppn2_pixel_pred'],
            self.summary_op
            ], feed_dict=feed_dict)
        ...
        #                'ppn2_pixels_pred': ppn2_pixels_pred,
                        'rois': rois}
